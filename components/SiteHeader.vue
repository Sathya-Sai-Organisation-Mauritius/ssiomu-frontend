<template>
  <header role="banner">
    ...
    <div class="main-menu-wrapper relative z-10">
      <div class="container flex justify-start md:justify-start items-center mx-auto">
        <div>
          <div id="block-tailwingcss-branding">
            <div class="flex items-center">
              <nuxt-link :to="{ name: 'index' }" title="Home" rel="home" class="site-logo mr-2">
        ...
        <div class="hidden md:block">
          <nav role="navigation">
            <ul class="flex ml-4">
              <li class="hover:bg-orange-600 hover" v-for="menu in menuRoot" :key="menu.url">
                <nuxt-link
                  :to="menu.url"
                  v-if="menu.url !== null"
              ...
              <li class="relative hover:bg-orange-500 hover">
                <div class="dropdown">
                  <nuxt-link :to="{name: 'regions'}" class="inline-flex items-center py-5 px-5">
                  ...
                  <ul class="dropdown-menu absolute block left-0 hidden block text-white-700 pt-xl">
              ...
              <li class="relative hover:bg-orange-500 hover">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu absolute left-0 hidden block text-white-700 pt-xl">
              ...
              <li class="relative hover:bg-orange-500 hover">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu absolute left-0 hidden block text-white-700 shadow-xl">
