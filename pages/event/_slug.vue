        ...
        <div class="container mx-auto">
          <div class="event-details space-y-12 py-10 m-8 md:m-0">
            ...
            >
              ...
              >
                <h1 class="font-serif text-3xl md:text-4xl lg:text-5xl">{{ events.name }}</h1>
              </div>
              <div
              ...
              >
                ...
                >
                  <nuxt-link
                    :to="{name: 'region-slug', params: { slug:   events.region.slug} }"
          ...
          <div class="event-details space-y-12 pb-10 m-8 md:m-0">
            <div class="md:grid grid-cols-2">
              <div class="event-description md:text-left text-center">
                ...
                >Description</h2>
                <div class="description-body space-y-2" v-html="events.description"></div>
              </div>
