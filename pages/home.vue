<<template>
    <div>
        ...
        <div class="front-landing">
          ...
          >
            ...
            <p class="text-xl w-1/2 pt-5">
              The main objective of the Sathya Sai Organisation is to help
              humanity recognize its inherent divinity. It is established to
              translate the principles of love and nonviolence into daily
              practice.
            </p>
          </div>
        </div>
          ...
          <div class="container mx-auto">
            <div>
              ...
              <div class="grid grid-cols-3 gap-8 text-blue-500">
                <div class="views-row bg-white p-8">
        ...
        <div class="">
          <div
            class="container mx-auto relative bg-gray-100 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8"
          >
        ...
        <div class="bg-gray-200">
          <div
            class="container mx-auto relative pt-12 pb-24 px-4 sm:px-6 lg:px-8"
          >
